...
import * as Belt_HashSet from '../node_modules/rescript/lib/es6/belt_HashSet.js'
...
function handleRequest(req) {
  ...
  var dealDoneWork = function (doneWorks) {
    var WorkRecordHash = Belt_Id.hashableU(
      function (entity) {
        return Belt_Option.getWithDefault(Belt_Int.fromString(entity.code), 1)
      },
      function (param, param$1) {
        return param.code === param$1.code
      },
    )
    return Belt_HashSet.toArray(
      Belt_HashSet.fromArray(
        doneWorks.map(function (doneWork) {
  ...
  return req
    ...
    .then(function (body) {
      ...
      var headers = Js_dict.fromArray([['Access-Control-Allow-Origin', origin]])
